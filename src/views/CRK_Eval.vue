<template>
	<v-container class="fill-height">
		<v-row aria-rowcount="20">
			...
			<v-col cols="12"></v-col>
			<v-col cols="12">
				<v-data-table :headers="headers" :items="ornteval" hide-default-footer>
					<template v-slot:top>
						<v-toolbar flat>
	...
	methods: {
		...
		save() {
			if (this.editedIndex > -1) {
				Object.assign(this.ornteval[this.editedIndex], this.editedEval);
			} else {
				this.ornteval.push(this.editedEval);
			}
			this.close();
		},
	},
